...
const Footer = () => {
  return (
    <div className='mt-28 bg-primary w-full'>
      <div className="w-full mx-auto px-[100px] text-white py-12 flex flex-col md:flex-row justify-between gap-12">
      ...
      <div className="bg-[#18124b] py-6 mt-4">
        <div className="w-full mx-auto px-[100px] flex flex-wrap gap-6 text-sm">
        ...
        <div className="w-full mx-auto px-[100px] mt-4 text-white text-xs">
